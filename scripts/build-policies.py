...
for slug,title in pages:
 ...
 doc='<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="theme-color" content="#101010"><title>'+html.escape(title)+' | White Stone Group</title><link rel="stylesheet" href="/legal.css"></head><body><header><a class="brand" href="/">WHITE STONE GROUP</a><a class="back" href="/">← Back to landing page</a></header><nav aria-label="Policies">'+nav+'</nav><main><article>'+body+'</article></main><footer><a href="/">Back to landing page</a><span>©2026 Whitestonegroup.in</span></footer></body></html>'
